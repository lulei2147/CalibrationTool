...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 10, 461, 321))
        ...
        self.widget.setGeometry(QtCore.QRect(480, 20, 151, 281))
        self.widget.setObjectName("widget")
        self.groupBox_2 = QtWidgets.QGroupBox(self.widget)
        self.groupBox_2.setGeometry(QtCore.QRect(50, 120, 97, 144))
        ...
        self.btn_set0 = QtWidgets.QPushButton(self.tab_3)
        self.btn_set0.setGeometry(QtCore.QRect(50, 20, 141, 31))
        self.btn_set0.setObjectName("btn_set0")
        self.btn_caliUpLimit = QtWidgets.QPushButton(self.tab_3)
        self.btn_caliUpLimit.setGeometry(QtCore.QRect(50, 70, 141, 31))
        self.btn_caliUpLimit.setObjectName("btn_caliUpLimit")
        self.btn_caliDownLimit = QtWidgets.QPushButton(self.tab_3)
        self.btn_caliDownLimit.setGeometry(QtCore.QRect(50, 130, 141, 31))
        self.btn_caliDownLimit.setObjectName("btn_caliDownLimit")
        ...
        self.btn_clear.clicked.connect(MainWindow.btnClearClicked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_set0.setText(_translate("MainWindow", "工厂调零"))
        self.btn_caliUpLimit.setText(_translate("MainWindow", "标定测量范围下限"))
        self.btn_caliDownLimit.setText(_translate("MainWindow", "标定测量范围上限"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "标定功能"))
